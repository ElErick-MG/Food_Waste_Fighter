...
<head>
    ...
    <title>Registrarse - Food Waste Fighter</title>
...
<body class="bg-gray-50 text-gray-800 min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-md p-6">
        ...
        <div class="bg-white p-8 rounded-xl shadow-lg">
            ...
            <form action="${pageContext.request.contextPath}/AuthController" method="post" onsubmit="return validarFormulario()">
                ...
                <div class="mb-6">
                    ...
                    <input type="password" id="confirmarContrasena" name="confirmarContrasena" required 
                        ...
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                    <p id="errorContrasena" class="text-red-500 text-sm mt-1 hidden">Las contraseñas no coinciden</p>
                </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-600">
                    ¿Ya tienes cuenta? 
                    <a href="${pageContext.request.contextPath}/AuthController?accion=login" class="text-green-600 hover:text-green-700 font-medium">
                        Inicia sesión
                    </a>
                </p>
            </div>
